      ...
      <main className="mx-auto flex max-w-3xl flex-col gap-8 px-6 py-14">
        <header className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 text-slate-300">
            ...
            <span className="hidden text-xs uppercase tracking-[0.2em] text-slate-400 sm:inline">Account</span>
          </div>
          <div className="inline-flex items-center gap-2 rounded-xl bg-emerald-500/15 px-4 py-2 text-sm font-semibold text-emerald-200 ring-1 ring-emerald-400/30">
            <Shield className="h-4 w-4" /> Secure settings
          </div>
        </header>
        ...
        <div className="glass-panel rounded-3xl p-[1.5px] shadow-2xl shadow-black/30">
          <div className="rounded-[calc(1.5rem-1.5px)] bg-gradient-to-br from-white/5 to-white/0 p-8">
            <div className="flex flex-col gap-2">
              <p className="text-sm uppercase tracking-[0.2em] text-slate-400">Your profile</p>
              <h1 className="text-3xl font-semibold text-white">Manage name and password</h1>
              <p className="text-slate-400">Update your display name or set a new password. Leave fields empty to keep current values.</p>
            </div>
            ...
            <form action={updateProfile} className="mt-8 space-y-6">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <p className="text-sm text-slate-400">Password is required only if you want to change it.</p>
                <button
                  type="submit"
