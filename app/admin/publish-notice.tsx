...
export default function PublishNotice({ show, title, subtitle }: Props) {
  ...
  return (
    <div className="fixed inset-x-0 top-4 z-50 flex justify-center px-4">
      <div className="flex max-w-xl items-center gap-3 rounded-2xl border border-amber-200/40 bg-slate-950/90 px-4 py-3 text-white shadow-2xl shadow-amber-500/20 ring-1 ring-amber-300/40 backdrop-blur-sm md:backdrop-blur">
